...
import { collection, doc as docRef, DocumentSnapshot, serverTimestamp, setDoc, updateDoc } from "firebase/firestore";
...
export interface QueueEditDialogProps {
  open: boolean;
  onClose: () => void;
  doc?: DocumentSnapshot<Queue>;
}

export function QueueEditDialog({onClose, open, doc}: QueueEditDialogProps) {
  ...
  const initialValues = (doc && doc.data()) || {
    name: '',
    description: '',
    clients: [],
    sections: [],
    ...
    <Dialog
      ...
      <form onSubmit={formik.handleSubmit} autoComplete="off" noValidate>
        <DialogTitle className="d-flex flex-row justify-content-between align-items-center">
          <span>{doc ? 'Edit' : 'Create'} Queue</span>
